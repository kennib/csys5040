...
;;
;; test opinion spread on different networks
;;
...
[
 decide-yes
  ...
  ;; set default values so weighted sum below works - in this model all links have same weight
  ask links [set weight 1]
  ask turtles [set opinion-threshold 0]
end
...
700
650
Basic opinion spread model added to Netlogo Network Extensions model to study effect of different networks on opinion spread
14
0.0
1
...
1120
675
To use:\n- Select a network set up\n- Select layout - recommend spring\n- Run layout\n- Seed opinions \n- Spread opinion to obtain opinion equilibrium
14
0.0
1
...
ADDED BASIC OPINION SPREAD VOTING MODEL TO STUDY OPINIO SPREAD ON DIFFERENT NETORK TOPOLOGIES
